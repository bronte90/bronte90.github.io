...
var windowGalaxyScroll = new ScrollMagic.Scene({
  ...
  offset: -250,
  duration: 200
}).setTween(galleryTl).addTo(controller);
...
$galleryProjects.each(function () {
  ...
  var galeryScene = new ScrollMagic.Scene({
    ...
    offset: 100
  }).setTween(galleryTween).addTo(controller);
});
